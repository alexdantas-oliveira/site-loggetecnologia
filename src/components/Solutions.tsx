...
const Solutions = () => {
  ...
  return <section id="solucoes" className="pt-16 md:pt-24 pb-0 bg-white">
    <div className="container mx-auto px-4 sm:px-6">
      ...
      <div id="transformamos" ref={solutionsRef} className={`scroll-reveal ${solutionsVisible ? 'revealed' : ''} bg-logge-gray-100 p-6 sm:p-8 md:p-12 rounded-2xl shadow-soft scroll-mt-24`}>
