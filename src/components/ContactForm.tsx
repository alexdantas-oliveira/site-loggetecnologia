...
const ContactForm = () => {
  ...
  return <section id="contato" className="py-12 sm:py-16 md:py-20 bg-white">
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
                ...
                <div>
                  ...
                  <Input id="email" name="email" type="email" value={formData.email} onChange={handleChange} placeholder="seu.email@empresa.com" required className="w-full" />
                </div>
              </div>
              ...
              <div className="mb-4 sm:mb-6">
                ...
                <Textarea id="message" name="message" value={formData.message} onChange={handleChange} placeholder="Descreva seu desafio ou necessidade..." required className="w-full min-h-[120px] sm:min-h-[150px]" />
              </div>

              <Button type="submit" className="btn-primary w-full py-2 sm:py-3" disabled={isSubmitting}>
