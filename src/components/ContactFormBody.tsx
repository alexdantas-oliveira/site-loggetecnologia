...
export const ContactFormBody = ({ onSuccess, className = "" }: ContactFormBodyProps) => {
  ...
  return (
    <div className={`grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-10 ${className}`}>
      <div className="lg:col-span-2">
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8 border border-gray-100">
